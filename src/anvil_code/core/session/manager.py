...
from anvil_code.core.bus.envelope import HandlerError
from anvil_code.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from anvil_code.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from anvil_code.core.bus.commands import SessionCompactResult
