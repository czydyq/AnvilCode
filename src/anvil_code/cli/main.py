...
from anvil_code.cli.commands.chat import cmd_chat
from anvil_code.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from anvil_code.cli.commands.ping import cmd_ping
from anvil_code.cli.commands.run import cmd_run
from anvil_code.cli.commands.trace import cmd_trace
from anvil_code.cli.commands.version import cmd_version
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="anvil", description="AnvilCode CLI")
